...
export const PORTFOLIO_ITEMS = [
  {
    id: initialId++,
    image: ['https://i.imgur.com/U3OgFnt.png', 'https://i.imgur.com/0x9A6n0.png', 'https://i.imgur.com/Ka2plSH.png', 'https://i.imgur.com/0x9A6n0.png'],
    title: 'Vanstreek groente en fruit',
    shortDescription: 'This is a system that brings local suppliers together with customer',
    description: 'This was a school project with the client Vanstreek, <br> ' +
    ...
    technologies: ['HTML', 'TYPESCRIPT', 'ANGULAR', 'REST', 'SPRING', 'MYSQL', 'JPA'],
